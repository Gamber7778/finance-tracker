...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex fixed left-0 top-0 z-30 h-full w-64 flex-col border-r border-zinc-800 bg-zinc-950">
            ...
            if (isMenu) {
              return (
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-zinc-500 active:text-zinc-300"
                >
                  <item.icon size={20} />
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 animate-fade-in">
          ...
          />
          <div
            className="absolute right-0 top-0 bottom-0 w-72 bg-zinc-950 border-l border-zinc-800 flex flex-col animate-slide-in"
          ...
          >
            ...
            <div className="border-t border-zinc-800 px-3 py-3">
              <button
                ...
                className="flex items-center gap-3 rounded-xl px-4 py-3.5 text-sm font-medium text-red-400 w-full active:bg-red-500/10"
              >
                <LogOut size={18} />
                Вийти
              </button>
