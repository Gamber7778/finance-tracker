...
export default function LoginScreen() {
  ...
  return (
    <div
      className="fixed inset-0 bg-zinc-950 flex items-center justify-center p-4 overflow-y-auto"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Логін"
                className="w-full rounded-xl border border-zinc-700 bg-zinc-800/50 px-4 py-3 text-base text-white placeholder-zinc-600 focus:border-emerald-500 focus:outline-none transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Пароль"
                  className="w-full rounded-xl border border-zinc-700 bg-zinc-800/50 px-4 py-3 pr-11 text-base text-white placeholder-zinc-600 focus:border-emerald-500 focus:outline-none transition-colors"
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-500 py-3.5 text-sm font-semibold text-black hover:bg-emerald-400 active:bg-emerald-600 transition-colors"
            >
